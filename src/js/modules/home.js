...
export const initHomePage = () => {
    ...
    const sampleDestinations = [
      { name: 'Paris', description: 'The city of lights.', image: '/images/paris.webp'},
      { name: 'Tokyo', description: 'A bustling metropolis.', image: '/images/tokyo.webp' },
      { name: 'Rio de Janeiro', description: 'Famous for its beaches.', image: '/images/rio.webp' }
    ];
